...
class MO extends Gettext_Translations {
	...
	function import_from_file($filename) {
		...
		$this->f=$filename;
		if(file_exists($this->f.".cache_h")) {
			return $this->import_from_cache($this->f);
	...
	function import_from_reader($reader) {
		...
		file_put_contents($this->f.".cache_h",serialize($headers));
		file_put_contents($this->f.".cache_e",serialize($this->entries));
		return true;
	}
	
	
	
	function import_from_cache($filename) {
				
				
				$headers=unserialize(file_get_contents($filename.".cache_h"));
				$entries=unserialize(file_get_contents($filename.".cache_e"));
